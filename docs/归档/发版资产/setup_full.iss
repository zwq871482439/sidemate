...
AppVerName=Sidemate v0.9.7 (Full)
...
; ====== P7-4: Ollama 引擎已删除（底座换 llama.cpp） ======
; ollama.exe (34MB) 不再打包

; ====== llama.cpp 运行时 Vulkan/CPU DLL (134MB) ======
...
; ====== LLM 模型: Qwen3.5 三档 Q4 (~4.4GB 总量: 0.8B/2B/4B) ======
; P7-4: 底座换 llama.cpp，模型改打裸 GGUF + meta.json
Source: "server\models\qwen3.5-0.8b-q4\*"; DestDir: "{app}\server\models\qwen3.5-0.8b-q4"; Flags: ignoreversion
Source: "server\models\qwen3.5-2b-q4\*"; DestDir: "{app}\server\models\qwen3.5-2b-q4"; Flags: ignoreversion
Source: "server\models\qwen3.5-4b-q4\*"; DestDir: "{app}\server\models\qwen3.5-4b-q4"; Flags: ignoreversion

...
| 版本 | 日期 | 说明 |
|------|------|------|
| **v0.9.6** | **2026-06-21** | **P6「前端统一化 + 三模式」**：并行模式 + KB 纯档案管理 + 设置页 Tab 化 + 17 项安全加固 |
| v0.9.5 | 2026-06-21 | P5「稳定与整洁」：启动重构 + 上下文治理 + 死代码清理 |
| v0.9.4 | 2026-04 | P4「双轨框架」：CloudEngine + AgentLoop + 依赖安全网 |

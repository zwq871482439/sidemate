...
| 版本 | 说明 |
|------|------|
| v0.9.7 | P6 打磨：Indigo 全页面重设计 + ClearBox 明盒 + step_model 架构重构 |
| v0.9.6 | P6：三模式（离线/在线/并行）+ KB 纯档案管理 + 设置页 Tab 化 |
| v0.9.5 | P5：启动重构 + 上下文治理 + 死代码清理 |
| v0.9.4 | P4：双轨框架 + CloudEngine + AgentLoop + 依赖安全网 |

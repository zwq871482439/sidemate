# -*- coding: utf-8 -*-
"""
pipelines/local_pipeline.py — 离线模式 SSE 管道
============================================================
管什么：聊天(chat) / 文档生成(doc) / 知识库问答(kb)
不管什么：AgentLoop（cloud 专属）/ 并行融合（parallel 专属）
共享依赖：_base.StreamContext / _base.sse_event / _base._sanitize_output / doc_action
私有逻辑：KB检索注入 / 保存对话 / action路由（都在本文件内，不碰别人）
============================================================

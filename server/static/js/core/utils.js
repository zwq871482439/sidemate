...
function iconSvg(name, size) {
  ...
  var icons = {
    ...
    chart: '<svg width="'+size+'" height="'+size+'" viewBox="0 0 14 14" fill="none" style="vertical-align:-2px"><path d="M2 12V2M2 12h10" stroke="currentColor" stroke-width="1.2" stroke-linecap="round"/><rect x="4" y="8" width="2" height="3" fill="currentColor" opacity=".7"/><rect x="7" y="5" width="2" height="6" fill="currentColor" opacity=".7"/><rect x="10" y="3" width="2" height="8" fill="currentColor" opacity=".7"/></svg>',
    slides: '<svg width="'+size+'" height="'+size+'" viewBox="0 0 14 14" fill="none" style="vertical-align:-2px"><rect x="1.5" y="2" width="11" height="7" rx="1" stroke="currentColor" stroke-width="1.2"/><path d="M7 9v3M4.5 12h5" stroke="currentColor" stroke-width="1.2" stroke-linecap="round"/><circle cx="4" cy="5" r=".8" fill="currentColor"/><path d="M6 5h5M6 7h4" stroke="currentColor" stroke-width="1" stroke-linecap="round"/></svg>'
  };
  return icons[name] || '';
}
